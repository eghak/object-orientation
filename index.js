...
class Cat {
  ...
  // meow() {
  //   console.log(`This is my cat`, this.name, `he is`, this.age, `and he is a`, this.color, `cat`);
  // }
}
 
let cat1 = new Cat(`Garfield`, 43, `orange`);
...
let phone1 = new Phone(`Apple`, `iPhone XR`, `125GB`, `red`, 700);
phone1.sell()
...
//Code Here
let phone2 = new Phone(`Apple`, `iPhone 6`, 64, `red`, 700);
let phone3 = new Phone(`Apple`, `iPhone 7`, 150, `red`, 750);
let phone4 = new Phone(`Apple`, `iPhone 8`, 512, `red`, 800);
...
class Vehicle {
  constructor(capacity, color, mileage) {
    ...
    this.move = function (miles)   {      
      // += for shorthand for addition
      this.mileage += miles;
       //When assigning a value, use the = 
      // EXAMPLE:
...
let car1 = new Vehicle(4, `red`, 200);
car1.move(400);
console.log(car1);
...
//Code Here
let car2 = new Vehicle(10, `silver`, 500);
let myFirstVehicle = car2;
...
let motorcycle1 = new Motorcycle(2,`red`,200,`honda`);
let myFirstMotorcycle = motorcycle1;
...
class Boat extends Vehicle {
  constructor(capacity, color, mileage, type, name) {
    this.capacity = capacity;
    this.color = color;
    this.mileage = mileage;
    this.type = type;
...
let boat1 = new Boat (4, `white`, 120, `yacht`, `John`)
this.thisIsSeaWorth = false;
